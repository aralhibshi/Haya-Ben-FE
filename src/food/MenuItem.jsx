...
export default function MenuItem(props) {
  return (
    <div className='flex flex-col'>
        <img src="/images/BentoBoxTemp.jpeg" alt="Menu Item" id='menuItem' className='rounded-t-3xl menuItem hover:cursor-pointer'/>
        <div className='w-full rounded-b-3xl py-2 text-center bg-slate-500'>
            <div className='flex flex-row justify-center items-center'>
                <img src="/images/icons/minus-circle.png" alt="Minus" id='menuItemIcon' onClick={props.handleClick}/>
